...
export const Card = ({ raw, resource: { src, alt, name, desc, id } }) => {
  return <Link key={id} to={`/anime/${id}`} className="pb-5 mb-7 mr-10 w-72 rounded border-2 border-blue-800 border-1 border-gray-700 bg-blue-900 hover:border-blue-900 hover:cursor-pointer hover:bg-blue-950">
